...
public abstract class Helpers {
  ...
  public static YouiDriver driver;
  ...
  //public static void init(IOSDriver webDriver, URL driverServerAddress) {
  public static void init(YouiDriver webDriver, URL driverServerAddress) {
    driver = webDriver;
